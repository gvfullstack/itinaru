...
import DraggableItineraryItem from "./editFormDraggableItineraryItem";
...
interface EditFormDroppableItineraryContainerProps {
  handleShowHideDescription: (curItineraryItem: ItineraryItem) => void;
}


const EditFormDroppableItineraryContainer: React.FC<EditFormDroppableItineraryContainerProps> = ({
...
////////////////////////////////////////////update start times
  ...
  console.log("itin items ", itineraryItems)
    ...
    if (i === 0 && updatedItems[i].userDefinedRespectedTime === false) {
        newStartTime = dayStartTime;    console.log("newStartTime", newStartTime, previousEndTime, dayStartTime)
...
export default EditFormDroppableItineraryContainer;
