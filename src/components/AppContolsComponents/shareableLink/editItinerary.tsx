...
const EditButton: React.FC = () => {
    ...
    const [currentlyEditingItinerary, setCurrentlyEditingItinerary] = useRecoilState(currentlyEditingItineraryState);
    ...
    const handleEditClick = async () => {
        if (currentlyViewingItinerary) {
            ...
            await store.put(updatedItinerary, `currentlyEditingItineraryStateEF_${currentUser?.uid}`);
            await tx.done;
