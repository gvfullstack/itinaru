...
const PreferredDiningExperience: React.FC = (props) => {

  const [userPreferences, setUserPreferences] = useRecoilState(userPreferencesAtom);
  const diningExperienceSoughtOptions = userPreferences.diningExperience;
...
export default PreferredDiningExperience;
