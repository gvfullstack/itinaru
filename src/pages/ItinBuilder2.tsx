...
const ItinBuilder = () => {
  ...
  const messageProps = [
    ...
    {   
        ...
        page: "20T",
        introText: "OMG!",
        infoText1: `${userInputs.destination} sounds fantastic!`,
    ...
    {   
        ...
        infoText1: `Here are popular neighborhoods to explore in ${userInputs.destination}.`, 
        ...
        createButtonText: createButtonText,
        nextButtonText: "to my suggections"
        },
    {   
        pageStep:12,
        page: "120T",
        introText: "Sweet!",
        infoText1: `Here are some attractions for ${userInputs.destination} that take into account the information you’ve provided so far.`,
    ...
    {   
        ...
        infoText2:  `Here are some transportation options for ${userInputs.destination}.`,
